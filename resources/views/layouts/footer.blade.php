<footer class="main-footer">
  <div class="row wrapper-footer">
    ...
    <div class="col-lg-4 d-lg-block d-none pr-xl-5 pr-lg-4">
      ...
      <div class="d-flex mt-4">
        ...
        <div class="ml-3">
          <p class="mb-4">Jl. Panglima Sudirman No.26, Sosutan, Sumbergedong, Kec. Trenggalek, Kabupaten Trenggalek, Jawa Timur 66311</p>
          <button class="btn btn-outline-green">Lihat Lokasi di Maps</button>
        </div>
      </div>
    </div>
  ...
  <div class="copyright d-lg-block d-none">
    <p class="mb-0">
      Copyright © 2017-2019 — NU CARE-LAZISNU TRENGGALEK — All Right Reserved
    </p>
  </div>
</footer>