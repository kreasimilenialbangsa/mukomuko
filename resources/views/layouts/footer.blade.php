<footer class="main-footer">
  <div class="container">
    <div class="row d-lg-flex d-none wrapper-footer">
      <div class="col-lg-4 pl-0 pr-xl-5 pr-lg-4">
        <img class="logo-footer" src="{{ asset('img/logo-nu.png') }}" alt="">
        <p class="mt-4">NU CARE-LAZISNU adalah situs resmi Lembaga Amil Zakat, Infaq dan Shadaqah Nahdlatul Ulama yang dikelola oleh PC NU Care-LAZISNU Kabupaten Mukomuko</p>
      </div>
      <div class="col-lg-3">
      ...
      <div class="col-lg-4 pr-xl-5 pr-lg-4">
      ...
      <div class="col-lg-1 px-0">
        <h6 class="clr-green">Ikuti Kami</h6>
        <div class="d-center mt-lg-4">
    ...
    <div class="text-center d-lg-none d-block">
      ...
      <div class="row nav-wrap m-0">
        ...
        <div class="col-4 px-0">
          <a class="nav-link" style="border-right: none" href="#">Visi & Misi</a>
        </div>
      </div>
      <div class="d-center justify-content-center">
        <a href="https://www.facebook.com/nu.mukomuko" target="_blank" class="mob-icon">
          <ion-icon class="ic-ion ic-sosmed" name="logo-facebook"></ion-icon>
        </a>
        <a href="" class="mob-icon">
          <ion-icon class="ic-ion ic-sosmed" name="logo-instagram"></ion-icon>
        </a>
        <a href="" class="mob-icon">
          <ion-icon class="ic-ion ic-sosmed" name="logo-twitter"></ion-icon>
    ...
    <div class="shortcut-footer d-lg-none d-block">
      <div class="d-flex justify-content-between">
        <a class="wrap-shortcut nav-link {{ Request::is('/') ? 'active' : '' }}"  href="{{ route('home') }}">
          <ion-icon class="h4" name="home"></ion-icon>
          <span>Home</span>
        </a>
        <a class="wrap-shortcut nav-link {{ Request::is('program') ? 'active' : '' }}" href="{{ route('program.index') }}">
          <ion-icon class="h4" name="pie-chart"></ion-icon>
          <span>Program</span>
        </a>
        <a class="wrap-shortcut nav-link {{ Request::is('berita') ? 'active' : '' }}" href="{{ route('news.index') }}">
          <ion-icon class="h4" name="newspaper"></ion-icon>
          <span>Berita</span>
        </a>
        <a class="wrap-shortcut nav-link {{ Request::is('donatur') ? 'active' : '' }}" href="{{ route('donatur.index') }}">
          <ion-icon class="h4" name="people"></ion-icon>
          <span>Donatur</span>
        </a>
        <a class="wrap-shortcut nav-link {{ Request::is('profile*') ? 'active' : '' }}" href="{{ route('user.profile') }}">
