...
@section('meta')
  <meta name="title" content="Program - NU CARE">
  ...
  <meta property="og:title" content="Program - NU CARE">
  ...
  <meta property="twitter:title" content="Program - NU CARE">
      ...
      <div class="row">
        ...
        <section class="col-12 sec-aydonation">
          ...
          <div class="d-flex mt-3 justify-content-center">
            {{ $programs->withQueryString()->onEachSide(0)->links('vendor.pagination.bootstrap-4') }}
          </div>
        </section>
      </div>
    </div>
