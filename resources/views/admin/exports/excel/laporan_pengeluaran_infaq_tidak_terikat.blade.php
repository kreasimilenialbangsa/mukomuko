<table>
    <thead>
        <tr>
            <th style="text-align: center;" colspan="5"><b>LAPORAN PENGELUARAN DANA</b></th>
        </tr>
        <tr>
            <th style="text-align: center;" colspan="5"><b>LAZISNU KABUPATEN MUKOMUKO</b></th>
        </tr>
        <tr>
            <th style="text-align: center;" colspan="5"><b>TANGGAL {{ strtoupper(\Carbon\Carbon::parse($date['from_date'])->isoFormat('DD MMM YYYY')) }} SAMPAI {{ strtoupper(\Carbon\Carbon::parse($date['to_date'])->isoFormat('DD MMM YYYY')) }}</b></th>
        </tr>
    </thead>
</table>
...
<table>
    ...
    <tfoot>
        <tr>
            <td colspan="4" style="text-align: center; background-color: #FFC000;"><strong>Total</strong></td>
