...
class IncomeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.pages.incomes.datatables_actions');
    }
    ...
    {
        return [
            'name' => ['className' => 'text-center', 'title' => 'Nama Perolehan'],
            'precent' => ['className' => 'text-center', 'title' => 'Persentase Perolehan (%)']
        ];
    }
